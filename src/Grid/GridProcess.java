...
public class GridProcess {
    ...
    public GridProcess(char[][] matrix, boolean iO, int x, int y, int width, int height, int blockSizeW, int blockSizeH, int streetWidthX, int streetWidthY, int nbBlocks) {
